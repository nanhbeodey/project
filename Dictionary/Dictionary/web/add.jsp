<%-- 
    Document   : add
    Created on : Mar 11, 2023, 4:33:34 PM
    Author     : Nanhbeo
--%>
...
<html>
    ...
    <body>
        ...
        <form method="post" action="AddNewWord">
            <table class="table">
                <thead>
                    <tr>
                        <th></th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Example</td>
                        <td><input name="vexp" value="${vn.vexp}" type="text" class="form-control"></td>
                        <td><input name="eexp" value="${eng.vexp}" type="text"  class="form-control"></td>
                    </tr>
                </tbody>
            </table>
            <input type="submit" name="Add" class="btn btn-primary" style="margin: 12px auto;">
        </form>
    </body>
</html>
